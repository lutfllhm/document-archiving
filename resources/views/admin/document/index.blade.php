            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/documents/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.document.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'title'">{{ trans('admin.document.columns.title') }}</th>
                                        <th is='sortable' class="text-center" :column="'published_at'">{{ trans('admin.document.columns.published_at') }}</th>
                                        <th is='sortable' :column="'enabled'">{{ trans('admin.document.columns.enabled') }}</th>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        <td>@{{ item.title }}</td>
                                            ...
                                            <span v-if="item.published_at <= now">
                                                ...
                                                <span v-if="item.published_at > now">
                                                <small>{{ trans('admin.document.actions.will_be_published') }}</small><br />
                                                @{{ item.published_at | datetime('DD.MM.YYYY, HH:mm') }}
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/documents/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.document.actions.create') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
